...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post discounts_url, params: { discount: { discount: @discount.discount, discount_amount: @discount.discount_amount, discounted_item_id: @discount.discounted_item_id, item_ids: @discount.item_ids } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { discount: @discount.discount, discount_amount: @discount.discount_amount, discounted_item_id: @discount.discounted_item_id, item_ids: @discount.item_ids } }
